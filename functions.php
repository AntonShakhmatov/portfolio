...
wp_enqueue_script('my-custom-script', get_template_directory_uri() .'/js/jquery.min.js', array('jquery'), null, true);

	wp_enqueue_script( 'portfolio-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );

	wp_enqueue_script( 'portfolio-animation', get_template_directory_uri() . '/js/animation.js', array(), _S_VERSION, true );
